...
//             '/facebook/setting-messages/config/' + idSettingMessage;
//         }
//       });
//   }, [data, token, total]);
// }
...
//         } else if (type == 'image') {
//           if (
//             itemList[i].content.url &&
//             itemList[i].content.url.indexOf('blob:http') === -1
//           ) {
...
//     <button
//       type="button"
//       onClick={() => removeOldBlocks()}
//       className="page-header__next-btn basic__btn"
//     >
//       Tiếp theo
//     </button>
//   );

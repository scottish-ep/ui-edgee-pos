...
interface OrderOffLineCreateProps {
  detail?: any;
}

const OrderOffLineCreate = (props: OrderOffLineCreateProps) => {
  const { detail } = props;
      ...
      <div className={styles.table_wrapper}>
        ...
        <div className="flex flex-col col-right overflow-hidden pl-[12px] w-[35%]">
          <div className="overflow-auto">
            ...
            <div className="mt-[16px]">
              ...
              <div className="flex justify-between my-[12px]">
                ...
                <div className={styles.no_info}>Chưa có thông tin khách hàng</div>
              {/* <div
                className={classNames(
          ...
          <div className="flex justify-end gap-[15px] mt-[16px]">
            <Button variant="third" width={280} className="text-[20px]"style={{height: "54px"}}>
              {' '}
              THANH TOÁN NHANH (F10)
            </Button>
            <Button variant="secondary" className="text-[20px]" width={120} style={{height: "54px"}}>
              {' '}
              IN (F12)
            </Button>
          </div>
...
export default OrderOffLineCreate;

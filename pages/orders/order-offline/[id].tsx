...
interface OrderOfflineDetailProps {
  detail?: any;
}

const OrderOfflineDetail = (props: OrderOfflineDetailProps) => {
  const { detail } = props;
        ...
        >
          ...
          <div className="flex flex-row gap-[10px]">
            ...
            <div className="flex flex-col gap-[25px] mt-[10px] w-[48%]">
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm font-base">CÒN THIẾU (TRẢ KHÁCH)</span>
                <span className="text-sm font-medium text-">180,000 đ</span>
              </div>
            </div>
          </div>
        </div>

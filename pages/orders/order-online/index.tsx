...
import { statusList, orderList } from '../../../utils/utils';
...
const ListOrderOnline = () => {
        ...
        const ContentItemSku = (
          <div className="td_items_skus">
            {isArray(record.order_item_skus) &&
              ...
              record.order_item_skus.map((orderItemSku: any, index: any) => {
  ...
  const handleResize =
    (index: any) =>
    (e: any, { size }: { size: any }) => {
      //Note: how to fix binding "x" implicitly has an any type
      const newColumns = [...columns];
      newColumns[index] = {
        ...newColumns[index],
        width: size.width,
      ...
      <div className="relative">
        <ReactDragListView.DragColumn {...dragProps}>
          <Table
            ...
            //   return {
            //     onClick: () =>
            //       (window.location.href = `orders/order-online/${record.order_id}`),
            //   };
            // }}

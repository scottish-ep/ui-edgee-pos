...
interface OrderOnLineCreateProps {
  detail?: any;
}

const OrderOnLineCreate = (props: OrderOnLineCreateProps) => {
  const { detail } = props;
      ...
      <div className={styles.table_wrapper}>
        ...
        <div className="flex flex-col col-right overflow-hidden pl-[12px] w-[35%]">
          ...
          <div className="flex justify-end gap-[15px] mt-[16px]">
            ...
            <Button variant="secondary" style={{height: "54px"}} className="text-[20px]" width={120} >
              {' '}
              IN (F12)
            </Button>
          </div>
...
export default OrderOnLineCreate;
